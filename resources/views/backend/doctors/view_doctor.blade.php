        ...
        <div class="card py-5">
            <div class="mx-5 row">
                <div class="col-6 p-0 pt-1">
                    <h5 class="mb-0"><i class="ri-information-line fs-3"></i> View Doctor Details | {{$data->doctor_id}}</h5>
                </div>
                <div class="col-6 text-end p-0">
                    <a href="{{route('doctors')}}" class="btn btn-flex btn-outline btn-color-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold waves-effect waves-light">Back</a>
                </div>
            </div>
            <hr>
                ...
                <div class="row">
                    <div class="col-4 mb-3">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control d-none" value="{{$data->id}}" name="id" readonly />
                            <input type="text" class="form-control" value="{{$data->name}}" name="name"  placeholder="Enter full name" readonly />
                            @error('name')
