...
<div class="row">
    <div class="col-12">
        <div class="card py-5">
            ...
            <hr>
            <form id="Form" action="{{route('create_doctor')}}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control mb-1" value="{{old('doj')}}" name="doj" placeholder="Month DD, YYYY" id="doj" readonly />
                                @error('doj')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="number" class="form-control mb-1" value="{{old('experience')}}" name="experience" pattern="^\d*(\.\d+)?$" placeholder="Enter experience" title="Please enter a valid number (integer or decimal).">
                                @error('experience')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
