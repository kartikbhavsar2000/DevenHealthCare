                    ...
                    <div class="row">
                        ...
                        <div class="col-3 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control mb-1" value="{{$data->doj}}" name="doj" placeholder="DD-MM-YYYY" id="doj" readonly />
                                @error('doj')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control mb-1" value="{{$data->specification}}" name="specification" placeholder="Enter specification" onkeyup="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
                                @error('specification')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control mb-1" value="{{$data->bank_name}}" name="bank_name" placeholder="Enter bank name"  onkeyup="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
                                @error('bank_name')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control mb-1" value="{{$data->acc_no}}" name="acc_no" placeholder="Enter account number" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                @error('acc_no')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control mb-1" value="{{$data->branch}}" name="branch" placeholder="Enter branch"  onkeyup="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')">
                                @error('branch')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control mb-1" value="{{$data->ifsc_code}}" name="ifsc_code" placeholder="Enter IFSC code" onkeyup="this.value = this.value.replace(/[^a-zA-Z0-9]/g, '')">
                                @error('ifsc_code')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
