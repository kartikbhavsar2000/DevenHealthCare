...
<div class="row">
    <div class="col-6 mb-5">
        <h4 class="mt-1 mb-1">Corporates</h4>
        <p class="mb-0"><a href="{{route('dashboard')}}">Home</a> / Corporates</p>
    </div>
    <div class="col-6 mb-5 text-end pt-5 pe-5">
        ...
        <a href="{{route('add_corporate')}}" class="btn btn-primary waves-effect waves-light"><i class="ri-add-line"></i> Add Corporate</a>
    </div>
    <div class="col-12">
        <!-- Role Table -->
        <div class="card">
...
<script>
    $('#kt_datatable').DataTable({
        ...
        ajax: "{{asset("get_corporates_list")}}",
        columns:[
            ...
            if(result.dismiss != 'cancel'){
                $.ajax({
                    ...
                    success:function(result)
                    {
                        Swal.fire({
                            title: 'Deleted!',
                            text: "The corporate deleted succsessfully!",
                            icon: 'success',
