...
<div class="row">
    <div class="col-12">
        <div class="card py-5">
            <div class="mx-5">
                <h5 class="mb-0">Change Password | {{$data->staff_id ?? ""}}</h5>
            </div>
            <hr>
            <form id="Form" action="{{route('change_staff_password_post')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body py-0">
                    ...
                    <input type="hidden" class="form-control mb-1" name="id" value="{{$data->id}}">
                </div>
                <hr>
