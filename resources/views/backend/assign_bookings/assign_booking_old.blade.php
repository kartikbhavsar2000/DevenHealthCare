                    ...
                    <div class="row">
                        <div id="CustomerDetails">
                            ...
                            <div class="row mx-5">
                                <div class="col-2">
                                    <p class="text-nowrap mb-2"><i class="ri-user-line ri-20px me-2"></i>Full Name</p>
                                    <p class="text-nowrap mb-2"><i class="ri-phone-line ri-20px me-2"></i>Address</p>
                                    <p class="text-nowrap mb-2"><i class="ri-mail-line ri-20px me-2"></i>Contact Number 1</p>
                                    <p class="text-nowrap mb-0"><i class="ri-calendar-schedule-line ri-20px me-2"></i>Contact Number 2</p>
                                </div>
                                <div class="col-4">
                                    <p class="text-nowrap mb-2"><span class="me-5">:</span> {{$booking->customer_details->name ?? ""}}</p>
                                    <p class="text-nowrap mb-2"><span class="me-5">:</span> {{$booking->customer_details->address ?? ""}}</p>
                        ...
                        <div class="row mb-4">
                            <div class="mb-2 col-lg-6 col-xl-6 col-12 mb-0">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control Date" name="start_date" value="{{$booking->start_date}}" id="BookingStartDate" disabled/>
                            ...
                            <div class="mb-2 col-lg-6 col-xl-6 col-12 mb-0">
                                <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control Date" name="end_date" value="{{$booking->end_date}}" id="BookingEndDate" disabled/>
                                    ...
                                    <div class="">
                                        <div class="row">
                                            <div class="mb-2 col-lg-5 col-xl-5 col-12 mb-0">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control Date" name="start_date" placeholder="DD-MM-YYYY"/>
                                                    <label for="BookingStartDate">Start Date</label>
                                                </div>
                                            </div>
                                            <div class="mb-2 col-lg-5 col-xl-5 col-12 mb-0">
                                                <div class="form-floating form-floating-outline">
                                                    <input type="text" class="form-control Date" name="end_date" placeholder="DD-MM-YYYY"/>
                                                    <label for="BookingEndDate">End Date</label>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="mb-2 col-lg-2 col-xl-2 col-12 mb-0">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <div class="form-floating form-floating-outline">
                                                                <input type="text" class="form-control staff-rate-input" value="00"  onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-2 col-lg-2 col-xl-2 col-12 mb-0">
                                                            <div class="input-group input-group-merge">
                                                                <span class="input-group-text">₹</span>
                                                                <div class="form-floating form-floating-outline">
                                                                    <input type="text" class="form-control doctor-rate-input" value="00" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
