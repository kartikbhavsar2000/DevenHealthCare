...
<div class="row">
    <div class="col-6 mb-5">
        <h4 class="mt-1 mb-1">Ambulance</h4>
        <p class="mb-0"><a href="{{route('dashboard')}}">Home</a> / Ambulance</p>
    </div>
    ...
    $('#kt_datatable').DataTable({
        ...
        columns:[
            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    return type === 'display' ?
                    '<a href="{{asset("/")}}edit_ambulance/' + data + '" class="btn btn-sm btn-icon btn-text-secondary rounded-pill delete-record waves-effect waves-light"><i class="ri-edit-box-line ri-20px"></i></a>' :
                    data;
                }
            },
        ],
