...
<div class="row">
    <div class="col-12">
        <div class="card py-5">
            ...
            <hr>
            <form id="Form" action="{{route('update_equipment')}}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <div class="mb-4">
                                ...
                                <div class="input-group mb-1">
                                    ...
                                    <input type="text" value="{{$data->cost_price}}" name="cost_price"  class="form-control"/>
                                </div>
                                @error('cost_price')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                        ...
                        <div class="col-6 mb-3">
                            <div class="mb-4">
                                ...
                                <div class="input-group mb-1">
                                    <span class="input-group-text">₹</span>
                                    <input type="text" value="{{$data->sell_price}}" name="sell_price"  class="form-control"/>
                                </div>
                                @error('sell_price')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
