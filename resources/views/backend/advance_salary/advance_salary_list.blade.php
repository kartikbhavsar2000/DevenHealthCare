    ...
    $('#kt_datatable').DataTable({
        ...
        columns:[
            ...
            { "data": "description" ,"defaultContent": "-"},
            {
                ...
                "render": function (data, type, row, meta) {
                    return type === 'display' ?
                    '<a href="{{asset("/")}}edit_advance_salary/' + data + '" class="btn btn-sm btn-icon btn-text-secondary rounded-pill delete-record waves-effect waves-light"><i class="ri-edit-box-line ri-20px"></i></a>' :
                    data;
                }
            },
        ],
