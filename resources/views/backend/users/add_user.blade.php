...
<div class="row">
    <div class="col-12">
        <div class="card py-5">
            ...
            <hr>
            <form id="Form" action="{{route('create_user')}}" method="POST">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="email" class="form-control mb-1" value="{{old('email')}}" name="email"  placeholder="Enter email"/>
                                @error('email')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6 mb-3">
                            <div class="mb-4">
                                ...
                                <input type="password" class="form-control mb-1" name="c_password"  placeholder="Enter confirm password"/>
                                @error('c_password')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
